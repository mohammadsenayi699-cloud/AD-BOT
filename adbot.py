...
DEFAULT_CONFIG = {
    ...
    "language": "fa",
    "welcome_message": " درود {username} خوش اومدی به روم تخت جمشید 🤠 امیدوارم لذت ببری از این اتاق آریای 🔥❤️ برای زدن دنس عدد 1-250 را ارسال کنید",
    "announcement_interval": 300,
    "announcement_message": "برای اجاره بات به آیدی @69.254 پیام دهید!"
}
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "693a6d9b992f406d55e9d8da")
    api_token = os.getenv("API_TOKEN", "84f4e1634092f8a6e4d9d41f22501e39a443c3c6fd562badd287b8808ba2ae5c")
