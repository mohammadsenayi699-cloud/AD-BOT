...
DEFAULT_CONFIG = {
    ...
    "announcement_message": "برای اجاره بات به آیدی @mmd._.1010 پیام دهید!"
}
...
async def main():
    ...
    api_token = os.getenv("API_TOKEN", "bfff55d87b313dd2c631552b60b4eaf19a663b8e77cc46d32b6dde4d26a793f4")
